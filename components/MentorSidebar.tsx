  ...
  return (
    <div className="flex h-full w-full flex-col rounded-[28px] bg-[#1C1D52] px-4 py-6 text-white shadow-[0_12px_40px_rgba(28,29,82,0.18)] sm:py-8">
      ...
      <Link
        href="/mentor/logout"
        onClick={onNavigate}
        className="mt-5 flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-medium text-white/90 transition hover:bg-white/10"
      >
