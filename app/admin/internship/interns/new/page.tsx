    ...
    <div className="mx-auto max-w-[1000px] space-y-5 p-6">
      ...
      <section className="rounded-[28px] bg-white p-6 shadow-[0_10px_30px_rgba(28,29,82,0.08)]">
        <div className="flex items-center justify-between border-b border-slate-200 pb-5">
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#5FBB46]">Add intern</p>
            <h1 className="mt-1 text-2xl font-semibold text-[#1C1D52]">Create internship profile</h1>
          </div>
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          ...
          <Field label="Start date" value="2026-09-15" />
        </div>
      </section>
    </div>
  )
