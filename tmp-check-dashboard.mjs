...
import { PrismaClient, AssessmentAttemptStatus, InternshipApplicationStatus, InternshipPaymentStatus, MentorAssignmentStatus, RoleName } from './generated/prisma/client/index.js';
